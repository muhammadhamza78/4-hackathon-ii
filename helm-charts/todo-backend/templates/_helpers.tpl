{{/*
==============================================================================
Todo Backend Helm Chart - Template Helpers
==============================================================================
*/}}
...
*/}}
{{- define "todo-backend.configmapName" -}}
{{- printf "%s-config" (include "todo-backend.fullname" .) }}
{{- end }}
...
{{- printf "%s-secrets" (include "todo-backend.fullname" .) }}
{{- end }}
